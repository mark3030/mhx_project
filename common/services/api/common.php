...
class common extends Object {
    ...
    public $apiKey = "";//!!!需自行设定!!!
    public $apiSecret = "";//!!!需自行设定!!!
    public $apiUrlTask = API_URL . "/mobile_report/v1/task";//运营商报告采集任务提交地址
    public $apiUrlStatus = API_URL . "/mobile_report/v1/task/status";//运营商报告采集状态查询地址
    public $apiUrlInput = API_URL . "/mobile_report/v1/task/input";//运营商报告验证码输入地址
    public $apiUrlReport = API_URL . "/mobile_report/v1/task/report";//运营商报告结果获取地址
    public $apiUrlData = API_URL . "/mobile_report/v1/task/data";//运营商报告原始数据获取地址
